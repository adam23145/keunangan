  ...
  <div class="container">
    <div class="login-box">
      ...
      <center>
        ...
        if (isset($_GET['alert'])) {
          if ($_GET['alert'] == "gagal") {
            ...
            echo "<div class='alert alert-warning'>SILAHKAN LOGIN UNTUK MENGAKSES</div>";
          }
        }
        ?>
      </center>
      ...
      <div class="login-box-body">
        ...
        <div class="text-center"> <img src="./assets/logoRestuBunda.jpeg" style="max-width:30%;">
          <br>

          <span style="color: Black;">
            <center>
              <h4><B>UD Restu Bunda</B></h4>
            </center>
          </span></p>
    ...
    <span style="color: white;">
      <center>
        <h5>copyright 2023 @najah team</h5>
      </center>
    </span></p>
