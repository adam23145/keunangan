                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="width:100%">
                                    <label>Nama Kategori</label>
                                    <input type="hidden" name="id" required="required" class="form-control" placeholder="id Kategori .." value="<?php echo $d['kategori_id']; ?>">
                                  ...
                                  <div class="form-group" style="width:100%;margin-bottom:20px">
                                    ...
                                    <select name="jenis" style="width:100%" class="form-control" required="required">
                                      <option value="">- Pilih -</option>
                                      <option <?php if($d['transaksi_jenis'] == 1){echo "selected='selected'";} ?> value=1>Pemasukan</option>
                                      <option <?php if($d['transaksi_jenis'] == 2){echo "selected='selected'";} ?> value=2>Pengeluaran</option>
                                    </select>
                                  </div>
