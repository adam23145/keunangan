      ...
      <section class="col-lg-12">
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            <!-- Modal -->
            <form action="divisi_act.php" method="post">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_divisi" required="required" class="form-control" placeholder="Nama Divisi ..">
                      </div>
                    </div>
                ...
                <tbody>
                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td> <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit_divisi_<?php echo $d['id_divisi'] ?>">
                            <i class="fa fa-cog"></i>
                          </button>
                        ...
                        <form action="divisi_update.php" method="post">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="width:100%">
                                    <label>Nama Divisi</label>
                                    <input type="hidden" name="id_divisi" required="required" class="form-control" placeholder="Nama Divisi .." value="<?php echo $d['id_divisi']; ?>">
                                    <input type="text" name="nama_divisi" required="required" class="form-control" placeholder="Nama Divisi .." value="<?php echo $d['nama_divisi']; ?>" style="width:100%">
                                  </div>
