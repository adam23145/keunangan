    ...
    $query = "SELECT id_detail_barang FROM detail_barang ORDER BY id_detail_barang DESC LIMIT 1";
		...
		if (mysqli_num_rows($result) > 0) {
			...
			if($_POST['harga_total'] == 0 ||$_POST['harga_total'] == ""){
				echo "<script>alert('Masih Kosong!'); window.location.href='operasional_mingguan.php';</script>";
			}else{
				...
				VALUES (NULL, '$_POST[tanggal]', 'Pengeluaran', '5', '$_POST[harga_total]', '$newID')";
				...
				echo "<script>alert('Penggajian berhasil di inputkan!'); window.location.href='operasional_mingguan.php';</script>";
			}
