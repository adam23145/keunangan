<?php
	...
	if ($cek > 0) {
		echo "<script>alert('Penginputan pada Minggu ini telah dilakukan!'); window.location.href='mesin.php';</script>";
	} else {
		...
		if (mysqli_num_rows($result) > 0) {
			...
			if($_POST['gaji_bersih'] == 0 ||$_POST['gaji_bersih'] == ""){
				echo "<script>alert('Penggajian Kosong!'); window.location.href='mesin.php';</script>";
			}else{
				...
				echo "<script>alert('Penggajian berhasil di inputkan!'); window.location.href='mesin.php';</script>";
			}
		} else {
