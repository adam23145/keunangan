...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
    <?php 
    $_SESSION["nama_divisi"] = 'Log Harian';
    $_SESSION["id_divisi"] = '1';
    ?>
                ...
                <div class="col-md-5">
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body panel-form">
                            ...
                            <form class="form-horizontal form-bordered" data-parsley-validate="true" name="absen" action="log_harian_absen_act.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                    <select name="id_pegawaii_absen" id="id_pegawaii_absen" data-live-search="true" data-style="btn-white" class="form-control selectpicker" required="required">
                                        <option value="" selected disabled>---- Pilih ID ----</option>
                                        <?php
                                        $id_divisi = $_SESSION["id_divisi"];
                                        $sql = mysqli_query($koneksi, "SELECT * FROM pegawai WHERE divisi ='$id_divisi'ORDER BY id_pegawai ASC") or die(mysqli_error($koneksi));
                                        while ($dt = mysqli_fetch_array($sql)) {
                                            echo '<option value="' . $dt['id_pegawai'] . '">' . $dt['id_pegawai'] . ' - ' . $dt['nama_pegawai'] . '</option>';
                                        }
                                        ?>
                                    </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" name="nama_pegawaii_absen" id="nama_pegawaii_absen"  data-parsley-required="true" readonly/>
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" data-parsley-validate="true" name="data_pengguna" action="log_harian_penggajian_act.php" method="POST">
                                <div class="form-group">
                                  <label class="control-label col-md-4 col-sm-4">Tanggal</label>
                                  <div class="col-md-6 col-sm-6">
                                    <input autocomplete="off" type="text" name="tanggal" required="required" class="form-control datepicker2" value="<?php echo date('Y/m/d'); ?>" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="id_pegawai_gaji" id="id_pegawai_gaji" data-live-search="true" data-style="btn-white" class="form-control selectpicker"  required="required">
                                             ...
                                             <?php
                                             $id_divisi = $_SESSION["id_divisi"];
                                             $sql = mysqli_query($koneksi,"SELECT * FROM pegawai WHERE divisi ='$id_divisi' ORDER BY id_pegawai ASC");
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-inline">
                                            <input class="form-control" type="number" name="gaji_pokok" id="gaji_pokok" data-parsley-required="true" readonly/>
                                        </div>
                                    </div>
                                </div>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-inline">
                                            <input class="form-control" type="number" name="hutang" id="hutang" value="0" data-parsley-required="true" readonly/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-4" >Hadir</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="number" name="kehadiran_penuh" value="" id="kehadiran_penuh"  data-parsley-required="true" data-parsley-type="number" readonly/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-4" >Setengah Hari</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="number" name="setengah_hari" id="setengah_hari" value="0" data-parsley-required="true" data-parsley-type="number" readonly/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-4" >Tanpa Keterangan</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="number" name="kehadiran_alpha" id="kehadiran_alpha"   value="" data-parsley-required="true" data-parsley-type="number"readonly/>
                                    </div>
                                </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                    <div class="form-inline">
                                            <input class="form-control" type="number" name="gaji_bersih" id="gaji_bersih"value="0" data-parsley-required="true" readonly/>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="log_harian_penggajian_hapus.php?id=<?php echo $d['transaksi_id'] ?>" class="btn btn-primary">Hapus</a>
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  $id_divisi = $_SESSION["id_divisi"];
                  $no=1;
                  $result = mysqli_query($koneksi,"SELECT * FROM absen JOIN pegawai ON absen.pegawai = pegawai.id_pegawai JOIN divisi ON pegawai.divisi = divisi.id_divisi WHERE divisi.id_divisi = '1' order by id_absen desc");
                  if ($result) {
                  while($d = mysqli_fetch_array($result)){
                    ...
                    <tr>
                      ...
                      <td class="text-center">    
                        <!-- <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit_transaksi_<?php echo $d['id_absen'] ?>">
                          <i class="fa fa-cog"></i>
                        </button> -->
...
<!-- 
                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#lihat_transaksi_<?php echo $d['id_absen'] ?>">
                          <i class="fa fa-eye"></i>
                        </button> -->
                        ...
                        <div class="modal fade" id="hapus_absen_<?php echo $d['id_absen'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                <a href="log_harian_absen_hapus.php?id=<?php echo $d['id_absen'] ?>" class="btn btn-primary">Hapus</a>
                              </div>
                            </div>
                          </div>
                        </div>
    ...
    <script>
                        $(document).ready(function(){
                            $('#id_pegawaii_absen').on('change',function(){
                                ...
                                $.ajax({
                                    url:'log_harian_absen_ambil_data.php',
                                    type:"POST",
                                    data:{
                                        modul:'NamaPegawai',
                          ...
                          $(document).ready(function(){
                            $('#id_pegawai_gaji').on('change',function(){
                              ...
                              $.ajax({
                                url:'log_harian_penggajian_ambil_data.php',
                                type:"POST",
                                data:{
                                  modul:'DataPegawai',
                                  id:id_pegawai_gaji
