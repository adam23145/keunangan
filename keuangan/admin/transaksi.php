                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        <label>Jenis Transaksi <p>*Pilih jenis terlebih dahulu</p></label>
                        <select name="jenis" class="form-control" required="required" id="id_jenis">
                                    <option>---Pilih---</option>
                                    <?php
                                        $sql = mysqli_query($koneksi,"SELECT * FROM transaksi_jenis order by id ASC") or die(mysqli_error($koneksi));
                                        while ($dt = mysqli_fetch_array($sql)) {
                                    ?>
                                        <option value="<?php echo $dt['id'] ?>"><?php echo $dt['nama_transaksi'] ?></option>
                                    <?php } ?>
                        </select>
                      </div>
                      <div class="form-group">
                        <label>Kategori</label>
                        <select name="kategori" class="form-control" required="required" id="id_kategori">
  ...
  <script>
                        $(document).ready(function(){
                            $('#id_jenis').on('change',function(){
                                ...
                                $.ajax({
                                    url:'transaksi_ambil_data.php',
                                    type:"POST",
                                    data:{
                                        modul:'JenisTransaksi',
                                        id:id_jenis
                                    },
                                    success:function(respond){
                                        $("#id_kategori").html(respond);
                                    },
                                    error:function(){
