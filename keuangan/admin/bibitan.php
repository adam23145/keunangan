...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
    <?php 
    $_SESSION["nama_divisi"] = 'Bibitan';
    $_SESSION["id_divisi"] = '3';
    ?>
                ...
                <div class="col-md-5">
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body panel-form">
                            ...
                            <form class="form-horizontal form-bordered" data-parsley-validate="true" name="absen" action="bibitan_absen_act.php" method="POST">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" data-parsley-validate="true" name="data_pengguna" action="bibitan_penggajian_act.php" method="POST">
                                <div class="form-group">
                                  <label class="control-label col-md-4 col-sm-4">Tanggal</label>
                                  <div class="col-md-6 col-sm-6">
                                    <input autocomplete="off" type="text" name="tanggal" required="required" class="form-control datepicker2" value="<?php echo date('Y/m/d'); ?>" readonly>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="bibitan_penggajian_hapus.php?id=<?php echo $d['transaksi_id'] ?>" class="btn btn-primary">Hapus</a>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="modal fade" id="hapus_absen_<?php echo $d['id_absen'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                <a href="bibitan_absen_hapus.php?id=<?php echo $d['id_absen'] ?>" class="btn btn-primary">Hapus</a>
                              </div>
                            </div>
                          </div>
                        </div>
    ...
    <script>
                        $(document).ready(function(){
                            $('#id_pegawaii_absen').on('change',function(){
                                ...
                                $.ajax({
                                    url:'bibitan_absen_ambil_data.php',
                                    type:"POST",
                                    data:{
                                        modul:'NamaPegawai',
                          ...
                          $(document).ready(function(){
                            $('#id_pegawai_gaji').on('change',function(){
                              ...
                              $.ajax({
                                url:'bibitan_penggajian_ambil_data.php',
                                type:"POST",
                                data:{
                                  modul:'DataPegawai',
                                  id:id_pegawai_gaji
