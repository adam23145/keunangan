<?php
	...
	if ($cek > 0) {
		echo "<script>alert('Absensi pada Minggu ini telah dilakukan!'); window.location.href='mesin.php';</script>";
	} else {
		if($hadir + $setengah_hari + $tanpa_keterangan == 6){
			...
			echo "<script>alert('Absensi salah!'); window.location.href='mesin.php';</script>";
		}
	}
?>