...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
    <?php 
    $_SESSION["operasional"] = 'Operasional Mingguan';
    $_SESSION["id_jenis_operasional"] = '4';
    ?>
                ...
                <div class="col-md-6">
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" data-parsley-validate="true" name="data_pengguna" action="operasional_mingguan_act.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                    <select name="id_barang" id="id_barang" data-live-search="true" data-style="btn-white" class="form-control selectpicker" readonly required="required">
                                        <option value="" selected disabled>-- Pilih --</option>
                                        <?php
                                        $id_jenis_operasional = '2'; // Assuming the ID is hardcoded for demonstration purposes
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  $no=1;
                  $data = mysqli_query($koneksi,"SELECT * FROM transaksi JOIN kategori ON transaksi_kategori = kategori_id JOIN detail_barang ON id_detail_barang = detail_transaksi JOIN barang_operasional ON detail_barang.nama_barang = id_barang WHERE kategori_id = 5");
                        ...
                        <div class="modal fade" id="hapus_transaksi_<?php echo $d['transaksi_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                <a href="operasional_mingguan_hapus.php?id=<?php echo $d['transaksi_id'] ?>" class="btn btn-primary">Hapus</a>
                              </div>
                            </div>
                          </div>
                        </div>
