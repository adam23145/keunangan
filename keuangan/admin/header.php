...
<head>
  ...
  <link rel="shortcut icon" href="../assets/logoRestuBunda.jpeg">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>Restubunda</b>App</span>
      </a>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="has-sub active">
              ...
              <li>
                ...
                <a href="divisi.php">
                  <i class="fa fa-folder"></i> <span>DIVISI</span>
                </a>
              </li>
              <li>
                <a href="jabatan.php">
                  <i class="fa fa-folder"></i> <span>JABATAN</span>
                </a>
              </li>
						</ul>
					</li>
          <li class="has-sub active">
						...
						<ul class="sub-menu">
                <li>
                <a href="log_harian.php">
                  <i class="fa fa-folder"></i> <span>LOG HARIAN</span>
                </a>
              </li>
              <li>
                <a href="mesin.php">
                  <i class="fa fa-folder"></i> <span>MESIN</span>
                </a>
              </li>

              <li>
                <a href="bibitan.php">
                  <i class="fa fa-folder"></i> <span>BIBITAN</span>
                </a>
              </li>
						</ul>
					</li>
          <li class="has-sub active">
						...
						<ul class="sub-menu">
                <li>
                <a href="barang_operasional.php">
                  <i class="fa fa-folder"></i> <span>BARANG OPERASIONAL</span>
                </a>
              </li>
              <li>
            <a href="operasional_harian.php">
              <i class="fa fa-folder"></i> <span>OPERASIONAL HARIAN</span>
            </a>
          </li>
          <li>
            <a href="operasional_mingguan.php">
              <i class="fa fa-folder"></i> <span>OPERASIONAL MINGGUAN</span>
            </a>
          </li>
						</ul>
					</li>
          <li>
            <a href="kas.php">
              <i class="fa fa-folder"></i> <span>Kas</span>
            </a>
          </li>
          <li>
            <a href="hutang.php">
              <i class="fa fa-folder"></i> <span>Hutang Pegawai</span>
            </a>
          </li>
          <!-- <li>
            <a href="bank.php">
              <i class="fa fa-building"></i> <span>ALAT PEMBAYARAN</span>
            </a>
          </li> -->
          <li>
            <a href="laporan.php">
